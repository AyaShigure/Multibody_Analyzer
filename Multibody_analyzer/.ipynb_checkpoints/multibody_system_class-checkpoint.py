...
class system_full_nonlinear_dynamics():
    def __init__(self, 
        ...
        self.Fullauto_shock_absorbing_control = False
    ...
    def Energy_shaping_controller_initialization(self, target_pose):
        ...
        target_state_vector = target_pose + [0] * self.system_dimension
        self.Energy_shaping_controller = energy_shaping_controller(self, target_state_vector, self.stable_u_vec_from_lqr_control)
        self.Energy_shaping_controller_is_created_flag = True

    
    def Fullauto_shock_absorbing_control_initialization(self):
        pass
    ...
    def print_controller_status(self):
        ...
        print('Use Fullauto shock absorbing control? ==> ' + '{}'.format(self.Fullauto_shock_absorbing_control))

        if self.Use_LQR == True and self.Use_Energy_shaper == True:
            print(bcolors.FAIL + '=================================================================================================' + bcolors.ENDC)
            print(               '                        WARNING! LQR and Energy Shaper are both active!!!!')
            print(bcolors.FAIL + '=================================================================================================' + bcolors.ENDC)
    ...
    def calculate_StateSpace_Lambdify_ConstraintForce_OdeForSolver(self):
        ...
        def ODE(t, X, pbar, state, g, *Control_force_vector):
            ...
            # print(state_vector_dummy)
            # print(type(state_vector_dummy))
            # print(list(state_vector_dummy))
            ################################################## Control scheme ##################
            ...
            if self.Use_Energy_shaper == True:
                Control_force_vector = self.Energy_shaping_controller.get_energy_shaping_control_vector(state_vector_dummy)
